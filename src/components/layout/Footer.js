        ...
        <div className="grid grid-cols-4 gap-12 mb-8">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  ...
                  className="text-text-muted/90 text-sm hover:text-text-muted transition-colors cursor-pointer"
                >
                  Interior Painting
                </Link>
              </li>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex space-x-4 mb-4">
              <div className="w-8 h-8 bg-primary hover:bg-secondary rounded-lg flex items-center justify-center cursor-pointer transition-colors">
