...
export default function ProjectsPage() {
  ...
  const updateProgress = async (projectId, change) => {
    ...
    const newProgress = Math.max(
      0,
      Math.min(100, (project.progress || 0) + change)
    );
          ...
          <div className="bg-white rounded-lg max-w-md w-full shadow-2xl border border-gray-200">
            <div className="p-6">
              ...
              <p className="text-gray-600 text-center mb-6">
                ...
                at <strong>{projectToDelete.project_address}</strong>? This
            ...
            <div className="p-6">
              ...
              {selectedProject.quotes && (
                <div className="mb-6">
                  ...
                  {/* ============================================ */}
                  {selectedProject.quotes.quote_items &&
                    selectedProject.quotes.quote_items.length > 0 && (
                      <div className="mt-4">
                        ...
                        <div className="overflow-x-auto">
                          <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                            ...
                            <tbody className="divide-y divide-gray-200">
                              ...
                              {selectedProject.quotes.quote_items.map(
                                (item) => (
                                  <tr
                                    key={item.id}
