...
export default function BookAppointment() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(
        `Error: ${error?.message || "Please try again or call us directly."}`
      );
    }
  ...
  const propertyTypes = [
    ...
    },
    {
      name: "Commercial",
      description:
        "Offices, retail spaces, restaurants, and commercial buildings",
    },
  ];
  ...
  const locationTypes = [
    {
      name: "Interior",
      description:
        "Indoor spaces - living rooms, bedrooms, kitchens, bathrooms",
    },
    {
      name: "Exterior",
