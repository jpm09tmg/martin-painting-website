...
import { Calendar, Clock, Phone, Mail, MapPin, User, Building, Home, CheckCircle, XCircle, AlertCircle, Filter, Search, ChevronLeft, ChevronRight, List, X } from 'lucide-react';
            ...
            {getCalendarDays().map((dayInfo, index) => {
              ...
              return (
                <div
                  ...
                  } ${isTodayDate ? 'border-green-600 border-2' : 'border-gray-200'}`}
                >
                  ...
                  <div className="space-y-1">
                    {dayAppointments.slice(0, 3).map((apt) => (
                      <button
                        ...
                        className={`w-full text-left px-2 py-1 rounded text-xs font-medium truncate border ${getStatusColor(apt.status)} hover:opacity-80 transition-opacity`}
                      >
                        {apt.appointmentTime || apt.preferredTime} - {apt.firstName} {apt.lastName}
                      </button>
                    ))}
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">{selectedAppointment.firstName} {selectedAppointment.lastName}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">{selectedAppointment.propertyAddress}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">
                    {new Date(selectedAppointment.appointmentDate || selectedAppointment.preferredDate).toLocaleDateString('en-US', {
                      weekday: 'long',
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric'
                    })} at {selectedAppointment.appointmentTime || selectedAppointment.preferredTime}
                  </p>
                </div>
              </div>

              <div className="flex items-start">
                {selectedAppointment.propertyType === 'Commercial' ? <Building className="w-5 h-5 text-gray-400 mr-3 mt-0.5" /> : <Home className="w-5 h-5 text-gray-400 mr-3 mt-0.5" />}
                <div>
                  <p className="text-sm text-gray-600">Property Type</p>
                  <p className="font-medium text-gray-900">{selectedAppointment.propertyType} - {selectedAppointment.locationType}</p>
                </div>
              </div>
              ...
              {selectedAppointment.projectDetails && (
                <div>
                  ...
                  <p className="text-gray-900 bg-gray-50 p-3 rounded-lg">{selectedAppointment.projectDetails}</p>
                </div>
              )}
            </div>
